...
public class URItems {
    ...
    public static final Item DRAGON_HELMET_IRON = new DragonArmorItem(2, EquipmentSlot.HEAD, new FabricItemSettings().maxCount(1));
    public static final Item DRAGON_HELMET_GOLD = new DragonArmorItem(3, EquipmentSlot.HEAD, new FabricItemSettings().maxCount(1));
    public static final Item DRAGON_HELMET_DIAMOND = new DragonArmorItem(4, EquipmentSlot.HEAD, new FabricItemSettings().maxCount(1));
    public static final Item DRAGON_CHESTPLATE_IRON = new DragonArmorItem(3, EquipmentSlot.CHEST, new FabricItemSettings().maxCount(1));
    public static final Item DRAGON_CHESTPLATE_GOLD = new DragonArmorItem(5, EquipmentSlot.CHEST, new FabricItemSettings().maxCount(1));
    public static final Item DRAGON_CHESTPLATE_DIAMOND = new DragonArmorItem(6, EquipmentSlot.CHEST, new FabricItemSettings().maxCount(1));
    public static final Item DRAGON_TAIL_ARMOR_IRON = new DragonArmorItem(1, EquipmentSlot.LEGS, new FabricItemSettings().maxCount(1));
    public static final Item DRAGON_TAIL_ARMOR_GOLD = new DragonArmorItem(2, EquipmentSlot.LEGS, new FabricItemSettings().maxCount(1));
    public static final Item DRAGON_TAIL_ARMOR_DIAMOND = new DragonArmorItem(3, EquipmentSlot.LEGS, new FabricItemSettings().maxCount(1));
    public static final Item MOLECLAW_HELMET_IRON = new DragonArmorItem(2, EquipmentSlot.HEAD, new FabricItemSettings().maxCount(1));
    public static final Item MOLECLAW_HELMET_GOLD = new DragonArmorItem(3, EquipmentSlot.HEAD, new FabricItemSettings().maxCount(1));
    public static final Item MOLECLAW_HELMET_DIAMOND = new DragonArmorItem(4, EquipmentSlot.HEAD, new FabricItemSettings().maxCount(1));
