...
public class URScreenHandlers{
    ...
    public static ScreenHandlerType<MagmamuncherScreenHandler> MAGMAMUNCHER_INVENTORY = null;
    ...
    public static void init() {
        ...
        MAGMAMUNCHER_INVENTORY = Registry.register(Registries.SCREEN_HANDLER,"magmamuncher_inventory", new ScreenHandlerType<>(MagmamuncherScreenHandler::new, FeatureFlags.VANILLA_FEATURES));
    }
}
