...
public class URUseConditionTypes {
    ...
    public static final UseConditionType<HeadMountUseCondition> HEAD_MOUNT_CONDITION = register("head_mount", new UseConditionType<>(HeadMountUseCondition.MAP_CODEC));
    public static final UseConditionType<MoleclawUseCondition> MOLECLAW_CONDITION = register("moleclaw", new UseConditionType<>(MoleclawUseCondition.MAP_CODEC));
