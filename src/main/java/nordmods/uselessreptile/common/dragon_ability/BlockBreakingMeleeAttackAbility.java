...
public class BlockBreakingMeleeAttackAbility extends MeleeAttackAbility{
    ...
    public BlockBreakingMeleeAttackAbility(CommonDragonAbilityData common, Data triggerableAbilityData, boolean aoe, Vec3 attackBoxCenterOffset, float attackBoxWidth, float attackBoxHeight, boolean moveBoxVertically) {
        super(common, triggerableAbilityData, aoe, attackBoxCenterOffset, attackBoxWidth, attackBoxHeight, moveBoxVertically);
    }
