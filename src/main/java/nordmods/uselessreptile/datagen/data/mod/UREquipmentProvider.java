...
public class UREquipmentProvider implements DataProvider {
    ...
    protected void addEntries() {
        ...
        addEntry(UREntities.MOLECLAW_ENTITY, URItems.MOLECLAW_HELMET_IRON, UselessReptile.id("textures/entity/moleclaw/moleclaw_helmet_iron.png"), moleclawHelmet, moleclawEmptyAnimation, true, Optional.empty(), Optional.empty());
        addEntry(UREntities.MOLECLAW_ENTITY, URItems.MOLECLAW_HELMET_GOLD, UselessReptile.id("textures/entity/moleclaw/moleclaw_helmet_gold.png"), moleclawHelmet, moleclawEmptyAnimation, true, Optional.empty(), Optional.empty());
        addEntry(UREntities.MOLECLAW_ENTITY, URItems.MOLECLAW_HELMET_DIAMOND, UselessReptile.id("textures/entity/moleclaw/moleclaw_helmet_diamond.png"), moleclawHelmet, moleclawEmptyAnimation, true, Optional.empty(), Optional.empty());
        addEntry(UREntities.MOLECLAW_ENTITY, URItems.MOLECLAW_HELMET_NETHERITE, UselessReptile.id("textures/entity/moleclaw/moleclaw_helmet_netherite.png"), moleclawHelmet, moleclawEmptyAnimation, true, Optional.empty(), Optional.empty());
        holder.put(UselessReptile.id("empty"), new EquipmentModelData(Optional.empty(), List.of()));
    }

    protected void addEntry(EntityType<? extends URDragonEntity> type, Item item, Identifier texture, Identifier model, Identifier animation, boolean translucent, Optional<Integer> maxPassengers, Optional<List<String>> hidBones) {
        EquipmentModelData.Equipment equipmentModelData = new EquipmentModelData.Equipment(BuiltInRegistries.ITEM.getKey(item), new ModelData(texture, model, animation, true, translucent), maxPassengers, hidBones);
    ...
    protected void addSaddle(EntityType<? extends URDragonEntity> type, Item saddleItem, int passengerAmount, List<String> hidBones) {
        ...
        addEntry(type, saddleItem, texture, model, animation, false, Optional.of(passengerAmount), hidBones.isEmpty() ? Optional.empty() : Optional.of(hidBones));
    }
    ...
    protected void addCommonArmor(EntityType<? extends URDragonEntity> type) {
        ...
        addEntry(type, URItems.DRAGON_HELMET_IRON, textureIron, modelHelmet, emptyAnimation, false, Optional.empty(), Optional.empty());
        addEntry(type, URItems.DRAGON_HELMET_GOLD, textureGold, modelHelmet, emptyAnimation, false, Optional.empty(), Optional.empty());
        addEntry(type, URItems.DRAGON_HELMET_DIAMOND, textureDiamond, modelHelmet, emptyAnimation, false, Optional.empty(), Optional.empty());
        addEntry(type, URItems.DRAGON_HELMET_NETHERITE, textureNetherite, modelHelmet, emptyAnimation, false, Optional.empty(), Optional.empty());
        addEntry(type, URItems.DRAGON_CHESTPLATE_IRON, textureIron, modelChestplate, emptyAnimation, false, Optional.empty(), Optional.empty());
        addEntry(type, URItems.DRAGON_CHESTPLATE_GOLD, textureGold, modelChestplate, emptyAnimation, false, Optional.empty(), Optional.empty());
        addEntry(type, URItems.DRAGON_CHESTPLATE_DIAMOND, textureDiamond, modelChestplate, emptyAnimation, false, Optional.empty(), Optional.empty());
        addEntry(type, URItems.DRAGON_CHESTPLATE_NETHERITE, textureNetherite, modelChestplate, emptyAnimation, false, Optional.empty(), Optional.empty());
        addEntry(type, URItems.DRAGON_TAIL_ARMOR_IRON, textureIron, modelTailArmor, emptyAnimation, false, Optional.empty(), Optional.empty());
        addEntry(type, URItems.DRAGON_TAIL_ARMOR_GOLD, textureGold, modelTailArmor, emptyAnimation, false, Optional.empty(), Optional.empty());
        addEntry(type, URItems.DRAGON_TAIL_ARMOR_DIAMOND, textureDiamond, modelTailArmor, emptyAnimation, false, Optional.empty(), Optional.empty());
        addEntry(type, URItems.DRAGON_TAIL_ARMOR_NETHERITE, textureNetherite, modelTailArmor, emptyAnimation, false, Optional.empty(), Optional.empty());
    }
