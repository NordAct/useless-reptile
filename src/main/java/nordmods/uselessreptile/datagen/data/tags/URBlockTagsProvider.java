...
public class URBlockTagsProvider extends FabricTagsProvider.BlockTagsProvider {
    public URBlockTagsProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
