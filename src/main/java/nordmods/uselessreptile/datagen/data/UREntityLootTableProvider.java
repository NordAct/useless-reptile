...
public class UREntityLootTableProvider extends FabricEntityLootSubProvider implements DataProvider {
        ...
        addEntry(UREntities.RIVER_PIKEHORN, LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(Items.COD)
                                ...
                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(enchantments, ContextFloatProviders.between(0, 3)))
        ...
        addEntry(UREntities.MOLECLAW, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(Items.GLOW_LICHEN)
                                .apply(SetItemCountFunction.setCount(ContextIntProviders.between(0, 2)))
                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(enchantments, ContextFloatProviders.between(0, 2))))));
        ...
        addEntry(UREntities.LIGHTNING_CHASER, LootTable.lootTable()
                .withPool(LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(Items.IRON_NUGGET)
                                ...
                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(enchantments, ContextFloatProviders.between(8, 16)))))
                .withPool(LootPool.lootPool()
                        .setRolls(ContextIntProviders.exactly(1))
                        .add(LootItem.lootTableItem(Items.BONE)
                                .apply(SetItemCountFunction.setCount(ContextIntProviders.between(0, 4)))
                                .apply(EnchantedCountIncreaseFunction.lootingMultiplier(enchantments, ContextFloatProviders.between(0, 4))))));
