    ...
    protected void configure(HolderLookup.@NonNull Provider registryLookup, SoundExporter exporter) {
        ...
        exporter.add(URSoundEvent.SHOCKWAVE,
                SoundTypeBuilder.of()
                        ...
                        .sound(SoundTypeBuilder.EntryBuilder.ofFile(UselessReptile.id("common/shockwave1")).attenuationDistance(URSoundEvent.SHOCKWAVE.fixedRange().orElseThrow().intValue()))
                        .sound(SoundTypeBuilder.EntryBuilder.ofFile(UselessReptile.id("common/shockwave2")).attenuationDistance(URSoundEvent.SHOCKWAVE.fixedRange().orElseThrow().intValue()))
                        .sound(SoundTypeBuilder.EntryBuilder.ofFile(UselessReptile.id("common/shockwave3")).attenuationDistance(URSoundEvent.SHOCKWAVE.fixedRange().orElseThrow().intValue()))
        );
        ...
        exporter.add(URSoundEvent.LIGHTNING_CHASER_DISTANT_ROAR,
                SoundTypeBuilder.of()
                        ...
                        .sound(SoundTypeBuilder.EntryBuilder.ofFile(UselessReptile.id("lightning_chaser/roar1")).attenuationDistance(URSoundEvent.LIGHTNING_CHASER_DISTANT_ROAR.fixedRange().orElseThrow().intValue()))
                        .sound(SoundTypeBuilder.EntryBuilder.ofFile(UselessReptile.id("lightning_chaser/roar2")).attenuationDistance(URSoundEvent.LIGHTNING_CHASER_DISTANT_ROAR.fixedRange().orElseThrow().intValue()))
                        .sound(SoundTypeBuilder.EntryBuilder.ofFile(UselessReptile.id("lightning_chaser/roar3")).attenuationDistance(URSoundEvent.LIGHTNING_CHASER_DISTANT_ROAR.fixedRange().orElseThrow().intValue()))
        );
        exporter.add(URSoundEvent.LIGHTNING_CHASER_ACCEPT_CHALLENGE,
                SoundTypeBuilder.of()
                        .subtitle("subtitles.uselessreptile.lightning_chaser.roar")
                        .sound(SoundTypeBuilder.EntryBuilder.ofFile(UselessReptile.id("lightning_chaser/accept_challenge")).attenuationDistance(URSoundEvent.LIGHTNING_CHASER_ACCEPT_CHALLENGE.fixedRange().orElseThrow().intValue()))
        );
        exporter.add(URSoundEvent.LIGHTNING_CHASER_SURRENDER,
                SoundTypeBuilder.of()
                        .subtitle("subtitles.uselessreptile.lightning_chaser.roar")
                        .sound(SoundTypeBuilder.EntryBuilder.ofFile(UselessReptile.id("lightning_chaser/surrender")).attenuationDistance(URSoundEvent.LIGHTNING_CHASER_SURRENDER.fixedRange().orElseThrow().intValue()))
        );
