...
public class DragonPassengerLayer<T extends DragonEquipmentAnimatable, R extends GeoRenderState> extends GeoRenderLayer<T, Void, R> {
    ...
    public DragonPassengerLayer(GeoRenderer<T, Void, R> entityRendererIn, BiFunction<R, GeoBone, ? extends EntityRenderState> passengerRenderStateGetter, BiFunction<R, GeoBone, EntityRenderer<? extends Entity, EntityRenderState>> passengerRenderGetter, BiFunction<R, GeoBone, UUID> passengerUUIDGetter) {
    ...
    @Nullable
    public Runnable createPerBoneRender(R renderState, MatrixStack matrixStackIn, GeoBone bone, RenderLayer renderType, VertexConsumerProvider bufferSource) {
