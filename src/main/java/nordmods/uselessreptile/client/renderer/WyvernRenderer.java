...
public class WyvernRenderer<R extends LivingEntityRenderState & GeoRenderState> extends URRideableDragonEntityRenderer<Wyvern, R> {
    ...
    @Override
    public void addRenderData(Wyvern animatable, Void relatedObject, R renderState, float tickDelta) {
